...
//     const currSpot = {...spot, ['createdAt']: spot.createdAt.toISOString().slice(0,19).replace('T', ' '), 
//     ['updatedAt']: spot.updatedAt.toISOString().slice(0,19).replace('T', ' ') }
    
//     spot.createdAt = spot.createdAt.toISOString().slice(0,19).replace('T', ' ');
//     spot.updatedAt = spot.updatedAt.toISOString().slice(0,19).replace('T', ' '); 
//     res.json(currSpot)
//   });
...
//         let {createdAt, updatedAt} = currSpot
//         currSpot.createdAt = createdAt.toISOString().slice(0,19).replace('T', ' ');
//         currSpot.updatedAt = updatedAt.toISOString().slice(0,19).replace('T', ' '); 
//         res.json(currSpot)
//       } 
...
//                   }
//                   let {createdAt, updatedAt} = newSpot
...
//         }));
//         let {createdAt, updatedAt} = newBooking
//         newBooking.createdAt = createdAt.toISOString().slice(0,19).replace('T', ' ');
//         newBooking.updatedAt = updatedAt.toISOString().slice(0,19).replace('T', ' '); 
...
//     let spot = spots[i];
//     let {id,ownerId,address,city,state,country,lat,lng,name,description,price, createdAt, updatedAt} = spot; 
//     // console.log(createdAt.toISOString().replace("T", " ").substr(0, 19))
//     let image = await SpotImage.findOne({
//       where: {spotId: {[Op.eq] :id}, preview:{ [Op.eq] : true}}, 
//       attributes: ['url']
...
//         let newDate = date.toISOString().replace("T", " ").substr(0, 19)
//         return newDate;
//        };
//           const newSpot = {
//               id,ownerId,address,city,state,country,lat,lng,name,description,price,
